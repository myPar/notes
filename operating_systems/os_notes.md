...
* сохранение статистики использования _вычислительных ресурсов_ и кода возврата в таблице процессов. Эти данные доступны родительскому процессу через системный вызов _wait(2)_.
