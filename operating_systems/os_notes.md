...
Когда прерывание нити активированно происходит следующее: вызываются _обработчики отмены_ (про которые будет написано позже), __после этого__ вызываются деструкторы _thread specific data_ и прочие ф-ции завершения работы потока.
