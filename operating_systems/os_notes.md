...
Если значение счётчика семафора к момент вызова данной ф-ции равно 0, то одному из потоков, которые заблокированы на _sem_wait()_ будет разрешено вернуться из её вызова. Если значение счётчика семафора к моменту вызова ф-ции положительно, то ни один поток не на семафоре не заблокирован и значение счётчика просто увеличивается.  
